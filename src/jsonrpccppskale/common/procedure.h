...
namespace jsonrpcskale
{
    ...
    class Procedure
    {
        public:
             ...
             * @param parameters - should contain the parameter-object of an valid json-rpc-skale 2.0 request
             * @see http://groups.google.com/group/json-rpc-skale/web/json-rpc-skale-2-0
