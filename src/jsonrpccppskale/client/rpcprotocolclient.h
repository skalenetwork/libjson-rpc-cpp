...
namespace jsonrpcskale {
    ...
    /**
     * @brief The RpcProtocolClient class handles the json-rpc-skale 2.0 protocol for the client side.
     */
    class RpcProtocolClient
    {
        public:
            ...
            /**
             * @brief This method builds a valid json-rpc-skale 2.0 request object based on passed parameters.
             * The id starts at 1 and is incremented for each request. To reset this value to one, call
             * the jsonrpcskale::RpcProRpcProtocolClient::resetId() method.
            ...
            /**
             * @brief BuildRequest does the same as std::string jsonrpcskale::RpcProRpcProtocolClient::BuildRequest(const std::string& method, const Json::Value& parameter);
