...
TEST_CASE_METHOD(F, "test_server_v2_method_success", TEST_MODULE) {
  ...
  c.SetRequest(
      "{\"jsonrpcskale\":\"2.0\", \"id\": 1, \"method\": \"sub\",\"params\":[5,7]}");
  CHECK(c.GetJsonResponse()["result"].asInt() == -2);
  CHECK(c.GetJsonResponse()["id"].asInt() == 1);
  CHECK(c.GetJsonResponse()["jsonrpcskale"].asString() == "2.0");
  CHECK(c.GetJsonResponse().isMember("error") == false);

  c.SetRequest("{\"jsonrpcskale\":\"2.0\", \"id\": null, \"method\": "
               "\"sub\",\"params\":[5,7]}");
  CHECK(c.GetJsonResponse()["result"].asInt() == -2);
  ...
  c.SetRequest("{\"jsonrpcskale\":\"2.0\", \"id\": 4294967295, \"method\": "
               "\"sub\",\"params\":[5,7]}");
  CHECK(c.GetJsonResponse()["result"].asInt() == -2);
...
TEST_CASE_METHOD(F, "test_server_v2_notification_success", TEST_MODULE) {
  c.SetRequest("{\"jsonrpcskale\":\"2.0\", \"method\": "
...
TEST_CASE_METHOD(F, "test_server_v2_invalidrequest", TEST_MODULE) {
  // wrong rpc version
  c.SetRequest("{\"jsonrpcskale\":\"1.0\", \"id\": 1, \"method\": "
               "\"sayHello\",\"params\":{\"name\":\"Peter\"}}");
  ...
  // no method name
  c.SetRequest(
      "{\"jsonrpcskale\":\"2.0\", \"id\": 1,\"params\":{\"name\":\"Peter\"}}");
  CHECK(c.GetJsonResponse()["error"]["code"] == -32600);
  CHECK(c.GetJsonResponse().isMember("result") == false);
  ...
  //
  c.SetRequest("{\"jsonrpcskale\":\"2.0\", \"id\": 3.2, \"method\": "
               "\"sayHello\",\"params\":{\"name\":\"Peter\"}}");
  CHECK(c.GetJsonResponse()["error"]["code"] == -32600);
  CHECK(c.GetJsonResponse().isMember("result") == false);
...
TEST_CASE_METHOD(F, "test_server_v2_method_error", TEST_MODULE) {
  ...
  c.SetRequest("{\"jsonrpcskale\":\"2.0\", \"method\": \"add\",\"params\":[3,4]}");
  CHECK(c.GetJsonResponse()["error"]["code"] == -32604);
  CHECK(c.GetJsonResponse().isMember("result") == false);

  // userspace exception
  c.SetRequest(
      "{\"jsonrpcskale\":\"2.0\", \"id\": 1, \"method\": \"exceptionMethod\"}");
...
TEST_CASE_METHOD(F, "test_server_v2_params_error", TEST_MODULE) {
  ...
  c.SetRequest("{\"jsonrpcskale\":\"2.0\", \"id\": 1, \"method\": \"sayHello\"}");
  CHECK(c.GetJsonResponse()["error"]["code"] == -32602);
  CHECK(c.GetJsonResponse().isMember("result") == false);
}
...
TEST_CASE_METHOD(F, "test_server_v2_batchcall_success", TEST_MODULE) {
  ...
  c.SetRequest("[{\"jsonrpcskale\":\"2.0\", \"id\": 1, \"method\": "
               "\"sayHello\",\"params\":{\"name\":\"Peter\"}},{\"jsonrpcskale\":\"2."
               "0\", \"id\": 2, \"method\": "
  ...
  c.SetRequest("[{\"jsonrpcskale\":\"2.0\", \"method\": "
               "\"initCounter\",\"params\":{\"value\":23}},{\"jsonrpcskale\":\"2."
               "0\", \"method\": \"initCounter\",\"params\":{\"value\":23}}]");
...
TEST_CASE_METHOD(F, "test_server_v2_batchcall_error", TEST_MODULE) {
  ...
  c.SetRequest("[{\"jsonrpcskale\":\"2.0\", \"id\": 1, \"method\": "
               "\"sayHello\",\"params\":{\"name\":\"Peter\"}},{},{\"jsonrpcskale\":"
               "\"2.0\", \"id\": 3, \"method\": "
...
TEST_CASE_METHOD(F1, "test_server_v1_method_success", TEST_MODULE) {
  ...
  CHECK(c.GetJsonResponse()["result"].asInt() == -2);
  CHECK(c.GetJsonResponse()["id"].asInt() == 1);
  CHECK(c.GetJsonResponse().isMember("jsonrpcskale") == false);
...
TEST_CASE("test_server_hybrid", TEST_MODULE) {
  ...
  c.SetRequest("{\"jsonrpcskale\":\"2.0\", \"params\":{\"value\": 33}}");
  CHECK(c.GetJsonResponse()["error"]["code"] == -32600);
  CHECK(c.GetJsonResponse().isMember("result") == false);
