...
void PythonClientStubGenerator::generateStub() {
  ...
  this->writeNewLine();
  this->writeLine("#");
  this->writeLine("# To use this client, jsonrpcskale_pyclient must be installed:");
  this->writeLine("# pip install jsonrpcskale_pyclient");
  this->writeLine("#");
  this->writeNewLine();
  this->writeLine("from jsonrpcskale_pyclient import client");
  this->writeNewLine();
